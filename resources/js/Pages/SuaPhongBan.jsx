                ...
                <div className="max-w-3xl mx-auto sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <div className="flex justify-end">
                            <Button
                                className="ml-6 px-4 py-3 bg-gradient-to-r  from-blue-500 to-indigo-600 text-white font-medium rounded-lg shadow-md transition duration-150 ease-in-out hover:from-teal-600 hover:to-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-600"
                                type="submit"
                            >
                                Cập nhật
                            </Button>
